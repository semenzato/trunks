...
// the counter handle supplied is invalid.
#define TCS_E_INVALID_COUNTER_HANDLE  (UINT32)(TSS_E_BASE + 0x0C6L)

// PCR size is wrong
#define TCS_E_SIZE  (UINT32)(TSS_E_BASE + 0x0C7L)
...
// TPM NVRAM has its max writes
#define TCS_E_MAXNVWRITES   (UINT32)(TSS_E_BASE + 0x0C9L)
...
// Delegate authorization failed
#define TCS_E_BAD_DELEGATE                        (UINT32)(TSS_E_BASE + 0x0CEL)
...
#define TCS_E_VERIFICATION_FAILED          TSS_E_VERIFICATION_FAILED
