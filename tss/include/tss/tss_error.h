...
#define TSS_CUSTOM_CODEFLAG     0x20000000L    // bit position for the custom flag in 
                                                                        // return code
//
// definitions for bitmasking for error codes
//
#define TSS_LAYER_MASK 0x0000F000L
#define TSS_ERROR_MASK 0x00000FFFL
...
//
// MessageId: TSS_E_KEY_NOT_REGISTERED
//
// MessageText:
//
//  Key isn't registered
//
#define TSS_E_KEY_NOT_REGISTERED  (UINT32)(TSS_E_BASE + 0x009L)
